...
const Sidebar = () => {
    ...
    function toggleActive(active : 'dashboard' | 'invoices' | 'vendor' | 'settings') {
    ...
    return (
        <div className=" h-screen overflow-hidden">
            <p className="p-4 mx-auto text-4xl text-[#212f3d] w-full ml-4">finifi</p>
            <div className="ml-4">                
                
                <div className={`mt-1 cursor-pointer p-2 ${isDashboardActive ? 'bg-[#273746] rounded-full rounded-r-none' : ''} `} onClick={() => toggleActive('dashboard')}>
                ...
                <div className={`mt-1 cursor-pointer p-2 ${isInvoicesActive ? 'bg-[#273746] rounded-full rounded-r-none' : ''} `} onClick={() => toggleActive('invoices')}>
                    <button className="flex justify-center items-center gap-2">
                ...
                <div className={`mt-1 cursor-pointer p-2 ${isVendorActive ? 'bg-[#273746] rounded-full rounded-r-none' : ''} `} onClick={() => toggleActive('vendor')}>
                    <button className="flex justify-center items-center gap-2">
                ...
                <div className={`mt-1 cursor-pointer p-2 ${isSettingsActive ? 'bg-[#273746] rounded-full rounded-r-none' : ''} `} onClick={() => toggleActive('settings')}>
                    <button className="flex justify-center items-center gap-2">
